...
class AppConfig(BaseModel):
    ...
    presentation_config: Optional[PresentationSettings] = Field(
        None, description="Presentation configuration"
    )
...
class Config:
    ...
    def _load_initial_config(self):
        ...
        config_dict = {
            ...
            "presentation_config": presentation_settings,
        }
    ...
    @property
    def presentation_config(self) -> Optional[PresentationSettings]:
        """Get the Presentation configuration"""
        return self._config.presentation_config
